 ...
 * @version $Id: class_phpmailer.php 450 2010-06-23 16:46:33Z coolbru $
 ...
 */
  ...
  protected function SmtpSend($header, $body) {
    ...
    if(!$this->smtp->Mail($smtp_from)) {
      throw new phpmailerException($this->Lang('from_failed') . $smtp_from, $this->STOP_CRITICAL);
    }
  ...
  */
  ...
  public function AddAttachment($path, $name = '', $encoding = 'base64', $type = 'application/octet-stream') {
    try {
      ...
      if ( $e->getCode() == $this->STOP_CRITICAL ) {
        return false;
      }
    }
    return true;
  ...
  public function set($name, $value = '') {
    try {
      if (isset($this->$name) ) {
        ...
        throw new phpmailerException($this->Lang('variable_set') . $name, $this->STOP_CRITICAL);
      }
    } catch (Exception $e) {
      $this->SetError($e->getMessage());
      if ($e->getCode() == $this->STOP_CRITICAL) {
