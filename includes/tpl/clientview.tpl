...
$(document).ready(function() {
        ...
        $(".suspendIcon").click(function(){
                if(status == "Suspend") {
                        ...
                        window.location = "%URL%<ADMINDIR>/?page=users&sub=search&do=%ID%&func=unsus";
                }
  ...
  <tr>
    ...
    <table width="100%" border="0" align="center" cellspacing="2" class="sub">
      ...
      <tr id="cancelTr">
        ...
        <td align="left"><a id="cancelLink" title="Removes this account from the package in THT. The account itself will not be touched." class="tooltip" href="javascript:void(0);">Cancel User</a></td>
      </tr>
      <tr>
