        ...
        <div class="sub">
            <table width="100%" border="0" cellspacing="2" cellpadding="0">
              <tr>
                ...
                <td width="65%" align="left"><input name="delete" id="delete" type="button" value="Delete Account" onclick="cancel('%USER%', document.getElementById('password').value)"/>  <a title="Click here to cancel your account." class="tooltip"><img src="<ICONDIR>information.png" /></a></td>
              </tr>
            </table>
        </div>
    </div>
