...
<table width="100%" border="0" cellspacing="3" cellpadding="0">
  ...
  <tr>
    ...
    <td>&nbsp;<a title="The sitewide currency format you'd like to use." class="tooltip"><img src="<URL>themes/icons/information.png" /></a></td>
  </tr>
  <tr>
    <td>Paypal Email:</td>
  ...
  <tr>
    <td colspan="3" align="center"><input type="submit" name="submit" id="submit" value="Save Settings" class="button" /></td>
    </tr>
</table>
</form>
