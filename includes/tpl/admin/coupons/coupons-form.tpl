...
<table class = "text" width="100%" border="0" cellspacing="0" cellpadding="0" style = "border-collapse:collapse;">
  ...
  <tr>
    <td align="center" colspan = "3"><input type="hidden" name="coupid" id="coupid" value="%ID%" /><input type="submit" name="%ADDEDIT%" id="%ADDEDIT%" value="%ADDEDIT% Coupon" class="button" /></td>
  </tr>
</table>
</form>
