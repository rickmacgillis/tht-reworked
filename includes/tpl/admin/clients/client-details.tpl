    ...
    <div class="sub">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="right"><a href="http://%DOMAIN%" target="_blank">%DOMAIN%</a>
          <a title="Their domain." class="tooltip"><img src="<URL>themes/icons/information.png" /></a></td>
        </tr>
      </table>
    </div>
</div>
    ...
    <div class="sub">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <a title="The status of their current hosting package." class="tooltip"><img src="<URL>themes/icons/information.png" /></a></td>
        </tr>
      </table>
    </div>
</div>
    ...
    <div class="sub">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <a title="How many unpaid invoices this client has." class="tooltip"><img src="<URL>themes/icons/information.png" /></a></td>
        </tr>
      </table>
    </div>
</div>
    ...
    <div class="sub">
     <form method = "POST">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class = "text">
        <tr>
          <td width = "100" valign = "top" height = "30">Current Package:</td>
          <td align = "left" valign = "top">
           <table width="100%" border="0" cellspacing="0" cellpadding="0" class = "text">
            <tr>
             <td valign = "top" height = "30">%PACKAGE%</td>
             <td align = "right" valign = "top"><a title="This shows their current package.  You may change it if you wish." class="tooltip"><img src="<URL>themes/icons/information.png" /></a></td>
            </tr>
            <tr>
             <td height = "30" colspan = "2"><input type = "checkbox" name = "immediately" value = "1"> Force the upgrade to happen immediately.</td>
            </tr>
           </table>
          </td>
        </tr>
        <tr>
         <td colspan = "2" align = "center" valign = "top"><font color = "#FF0055">%UPGRADEINFO%</font><input type = 'submit' name = 'submitnewpack' id = 'submitnewpack' value = 'Change'></td>
        </tr>
      </table>
     </form>
    </div>
