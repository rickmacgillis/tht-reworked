    ...
    <div class="sub">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="right"><a href="?page=users&sub=list&do=all">%CLIENTS%</a>
...
<div class="subborder">
    <div class="sub">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="50%">Awaiting Initial Payment From:</td>
          <td align="right"><a href="?page=users&sub=list&do=4">%PAYMENT%</a>  <a title="The amount of clients that you are waiting on for their first payment." class="tooltip"><img src="<URL>themes/icons/information.png" /></a></td>
        </tr>
      </table>
    </div>
</div>
<div class="subborder">
    <div class="sub">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="50%">Awaiting Email Confirmation:</td>
          <td align="right"><a href="?page=users&sub=list&do=5">%CONFIRM%</a>  <a title="The amount of clients that you are waiting on to confirm their email address." class="tooltip"><img src="<URL>themes/icons/information.png" /></a></td>
        </tr>
      </table>
    </div>
</div>
