 ...
 <div class="sub">
  <table class = "text" width="100%" cellspacing="0" cellpadding="3" border="0" style="border-collapse: collapse">
   <tr>
    ...
    <td><input type = "submit" value = "Search" name = "submitusers" id = "submitusers" class="button"></td>
   </tr>
   <tr>
    ...
    <td><input type = "submit" value = "Search" name = "submittype" id = "submittype" class="button"></td>
   </tr>
   <tr>
    ...
    <td><input type = "submit" value = "Search" name = "submitstatus" id = "submitstatus" class="button"></td>
   </tr>
  </table>
 </div>
</div>
 ...
 <div class="sub">
  <table class = "text" width="100%" cellspacing="0" cellpadding="3" border="0" style="border-collapse: collapse">
   <tr bgcolor="#EEEEEE">
    ...
    <td width="100" align="center">Bill Amt.</td>
    <td width="100" align="center">Total Paid</td>
