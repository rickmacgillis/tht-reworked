...
<table width="100%" border="0" cellspacing="2" cellpadding="0" id="smtp" style="display:none;">
      ...
      <tr>
        <td>SMTP Port:</td>
        <td align="right"><input name="smtp_port" id="smtp_port" type="text" value="%SMTP_PORT%" />
        <a title="Your SMTP Port (Usually 25 for non-SSL, 465 for SSL)" class="tooltip"><img src="<ICONDIR>information.png" /></a></td>
      </tr>
       <tr>
        <td>SMTP Username:</td>
        <td align="right">
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
      <tr>
    <td colspan="2" align="center"><input type="submit" name="add" id="add" value="Edit Email Settings" class="button" /></td>
  </tr>
</table>
</form>
