...
<form id="add" name="add" method="post" action="">
  <table width="100%" border="0" cellspacing="3" cellpadding="0">
    <tr>
     ...
     <td><label><input name="hostname" type="text" class="form" id="hostname" value="localhost" /></label></td>
    </tr>
    <tr>
     <td>Forum Name:</td>
     <td><label><input name="name" type="text" class="form" id="name" maxlength="28"/></label></td>
    </tr>
    <tr>
     <td width="30%">mySQL Username:</td>
     <td><label><input name="username" type="text" class="form" id="username" /></label></td>
    </tr>
    <tr>
     <td>mySQL Password:</td>
     <td><label><input name="password" type="password" class="form" id="password" /></label></td>
    </tr>
    <tr>
     <td>mySQL Database:</td>
     <td><label><input name="database" type="text" class="form" id="database" /></label></td>
    </tr>
    <tr>
    ...
    <tr>
     <td colspan="2" align="center"><label><input type="submit" name="type" id="type" value="Add Forum" class="button" /></label></td>
    </tr>
  </table>
</form>
