This is the email an admin recieves when a user upgrades/downgrades their account and requires their account to be manually upgraded because the server doesn't have an upgrade function.<br />
<br />
