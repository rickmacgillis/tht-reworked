This is the email an admin recieves when a user upgrades/downgrades their account and requires admin approval AND is changing to a plan on a new server.<br />
<br />
