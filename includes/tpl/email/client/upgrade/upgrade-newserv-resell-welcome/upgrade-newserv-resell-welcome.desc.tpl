This is the email a client gets when they upgrade to a RESELLER package and the new package is on a NEW server. This email should contain all they're details.<br />
<br />
