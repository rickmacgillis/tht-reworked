<br />This is the email a client gets when they change their plan to a NON-RESELLER package on the SAME server. This email should contain all they're details.<br />
<br />
...
%CPPORT% - The port for the client's control panel.  (Ex. cPanel)
