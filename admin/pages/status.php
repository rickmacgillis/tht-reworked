...
class page {
        ...
        public function server_status() {
                ...
                $array['EXTRA'] = '';
                if(!$main->canRun('shell_exec')) {
                        $array['EXTRA'] = 'Some statistics could not be provided because shell_exec has been disabled.<br>';
                }
                ...
                if($mysqlVersion) {
                        $array['MYSQL_VERSION'] = '<tr><td><strong>MySQL Version:</strong><br><br></td><td> '.$mysqlVersion.' <br><br></td></tr>';
                }
                $array['SERVER'] = $server;
