...
class page {
        ...
        public function checkPerms($file,$friendly){
                if (is_writable($file)){
                        return "<div class='warn'><img src='../themes/icons/error.png' alt='' /> Warning: $friendly is world writable, please chmod it to 0644!  (Your FTP service may require 0755.)</div>";
                }
                else{
        ...
        public function health() {
                ...
                $array['CHECK_ACPDIR'] = $this->checkPerms(LINK."../".ADMINDIR."/", "Admin Folder");
