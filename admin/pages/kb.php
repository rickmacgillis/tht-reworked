                ...
                switch($main->getvar['sub']) {
                        ...
                        case "art":
                                ...
                                if($_POST['edit']) {
                                        ...
                                        if(!$n) {
                                                $db->query("UPDATE `<PRE>articles` SET `name` = '{$main->postvar['editname']}', `content` = '{$main->postvar['editdescription']}', catid = '{$main->postvar['catidedit']}' WHERE `id` = '{$main->postvar['id']}'");
                                ...
                                $array4['DROPDOWN'] = $main->dropDown("catidedit", $values);
                                $array['CATIDEDIT'] = $style->replaceVar("tpl/support/catid.tpl", $array4);
