...
function installstuff() {
        ...
        $.get("includes/ajax.install.php?function=install&version="+encodeURIComponent('%VERSION%')+etc, function(myinstall) {
